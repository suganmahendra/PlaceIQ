...
import { LavenderPlants } from '../../components/landing/LavenderPlants';
            ...
            <div className="relative z-10">
                ...
                <section className="py-20 px-4">
                    <div className="container mx-auto">
                        <div className="bg-gradient-to-r from-primary to-accent rounded-3xl p-10 md:p-20 text-center text-white shadow-2xl relative overflow-hidden glass-card">
                            {/* Decorative circles */}
